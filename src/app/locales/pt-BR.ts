export const ptBR = {
  ...
  signup: {
    ...
    nativeLanguageHint: 'Usado na transcrição por voz e nos seus insights. A interface continua em português ou inglês.',
  ...
  profile: {
    ...
    language: 'Idioma',
    nativeLanguage: 'Idioma nativo',
    nativeLangCooldown: 'Você poderá trocar o idioma nativo novamente em {{days}} dias.',
    nativeLangTranslating: 'Idioma alterado. Traduzindo seus insights para o novo idioma...',
    nativeLangDone: 'Pronto. Seus insights agora estão no novo idioma.',
    theme: 'Tema',
    themeLight: 'Claro',
    themeDark: 'Escuro',
    themeSystem: 'Sistema',
